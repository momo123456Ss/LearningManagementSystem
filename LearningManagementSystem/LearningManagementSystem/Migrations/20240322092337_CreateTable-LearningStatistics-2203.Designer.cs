...
namespace LearningManagementSystem.Migrations
{
    ...
    [Migration("20240322092337_CreateTable-LearningStatistics-2203")]
    partial class CreateTableLearningStatistics2203
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningManagementSystem.Entity.ExamAndTestQuestions", b =>
                {
                    ...
                    b.Property<string>("ExamAndTestQuestionContent")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.ToTable("ExamAndTestQuestions");
                });
            ...
            modelBuilder.Entity("LearningManagementSystem.Entity.LearningStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearningManagementSystem.Entity.ExamAndTestQuestions", b =>
                {
                    b.HasOne("LearningManagementSystem.Entity.Faculty", "FacultyNavigation")
                        .WithMany("ExamAndTestQuestionss")
                        .HasForeignKey("FacultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LearningManagementSystem.Entity.LearningStatistics", b =>
                {
                    ...
                    b.HasOne("LearningManagementSystem.Entity.User", "StudentNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("LearningManagementSystem.Entity.Faculty", b =>
                {
                    ...
                    b.Navigation("ExamAndTestQuestionss");
